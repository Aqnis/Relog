...
EmBeRaaaq, а не emberaaaq. Написание ника должно быть как на сервере;
...
5) Также запуск должен быть от "Имени Администратора", ПКМ по ExRelog.exe;
При несоблюдении вышеперечисленных пунктов бот не запустится, либо будет работать некорректно.
----------------------------------------------
''')
